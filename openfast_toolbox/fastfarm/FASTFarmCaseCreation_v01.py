                ...
                if self.hasController:
                    ...
                    for seed in range(self.nSeeds):
                        try:
                            ...
                            dst = os.path.join(self.path, self.condDirList[cond], self.caseDirList[case], f'Seed_{seed}', self.controllerInputfilename)
    ...
    def setTemplateFilename(self, templatePath=None, templateFiles=None):
        ...
        for key, value in templateFiles.items():
            ...
            if key == 'EDfilename':
                ...
                if not (value.lower().endswith('.so') or value.lower().endswith('.dll')):
