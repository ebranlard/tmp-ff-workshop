...
if flat:
    ...
    simPath = '_ff_example_2a_linux_directory'            # folder (preferably new) where all the simulation files will be written
...
templateFiles = {'libdisconfilepath': './template/libdiscon_rosco_v2.9.0.so'}
